...
const NAV_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/dashboard/accounting/reports', label: 'Hub de Reportes', icon: '📑' },
      ...
      { href: '/dashboard/accounting/reports/cashflow', label: 'Flujo de Caja', icon: '💧' },
      { href: '/dashboard/accounting/expenses', label: 'Gastos', icon: '💸' },
      { href: '/dashboard/accounting/payroll', label: 'Nómina', icon: '👥' },
      { href: '/dashboard/accounting/assets', label: 'Activos Fijos', icon: '🏭' },
      { href: '/dashboard/accounting/bank-reconciliation', label: 'Conciliación Bancaria', icon: '🏦' },
